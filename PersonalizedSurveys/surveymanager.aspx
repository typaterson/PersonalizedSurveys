            ...
            <div class="col-xl-9 col-sm-9 col-md-9 col-lg-9">
                ...
                border-top:solid 2px black;border-radius:5px;">
                    ...
                    <%--<asp:PlaceHolder ID="ViewSurveyPlaceholder" runat="server">
                        ...
                        <h5>View Survey</h5>
                        <hr />
                        <asp:Button ID="CancelViewSurveybtn1" CssClass="btn btn-secondary btn-sm" runat="server" 
                            Text="Exit" OnClick="Cancelbtn_OnClick" Style="margin-bottom:10px;margin-top:10px;
                            margin-right:15px;"/>
                        <hr />
                        <div class="row">
                            <div class="col-6">
                                <div class="container" style="border:solid black 1px;border-radius:5px;padding-top:10px;">
                                    <asp:Label ID="Label2" runat="server" Text="Survey Title: "></asp:Label>
                                    <br />
                                    ...
                                    <h6>Questions</h6>
                                    <hr />
                                    <asp:Placeholder ID="ViewQuestionsPlaceholder" runat="server">
                        ...
                        <hr />
                        <asp:Button ID="CancelViewSurveyBtn2" CssClass="btn btn-secondary btn-sm" runat="server" 
                            Text="Exit" OnClick="Cancelbtn_OnClick" Style="margin-bottom:10px;margin-top:10px;
                            margin-right:15px;"/>
                        <hr />
                    </asp:PlaceHolder>--%>
