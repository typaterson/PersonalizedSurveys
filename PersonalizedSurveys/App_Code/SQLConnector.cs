            ...
            using(SqlDataAdapter sda = new SqlDataAdapter())
            {
                ...
                using (DataTable dt = new DataTable())
                {
                    ...
                    foreach(DataRow row in dt.Rows)
                    {
                        ...
                        Survey s = new Survey(SurveyID, LayoutID, UserID, Tittle, active);
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    ...
                    using (DataTable dt = new DataTable())
                    {
                        ...
                        foreach (DataRow row in dt.Rows)
                        {
                            ...
                            s = new Survey(SurveyID, LayoutID, UserID, Tittle, Active);
                        }
                    }
                }
            }
            ...
            using (SqlDataAdapter sda = new SqlDataAdapter())
            {
                ...
                using (DataTable dt = new DataTable())
                {
                    ...
                    foreach (DataRow row in dt.Rows)
                    {
                        ...
                        {
                            s.addQuestion(QuestionID, Text, Type, Target, number, CommentBox);
                        }
                    }
                }
            }
